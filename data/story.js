const storyEls = [
  ...
  {storyOrder: 5, scriptText: "You follow the octopus to rocky caves. It's darker down here, but you can see that the rocks are covered in clams. You could get used to this! The octopus chows down, she's trying to gain 1 - 2% body weight per day. You reach out to grab a clam, when a sea otter grabs it out of your hand. With all this competition for food, you give up and swim home to make a peanut butter sandwich", choiceOne: " ", choiceTwo: " " , choiceOneResults: null, choiceTwoResults: null},

  {storyOrder: 6, scriptText: "You choose Kelp. As you swim to the kelp forest you see a flickering light. Do you explore the light, or keep swimming into the dark forest", choiceOne: "Dark" , choiceTwo: "Light" , choiceOneResults: 7, choiceTwoResults: 8},

  {storyOrder: 7, scriptText: "You choose to to keep swimming into the dark. You do not see a 6-gill shark approaching, and you are eaten in one bite.", choiceOne: " " , choiceTwo: " " , choiceOneResults: null, choiceTwoResults: null},

  {storyOrder: 8, scriptText: "You follow the light, and find biolumensent jellyfish. It's the calmest you've ever felt. As you slip into a meditative state you hear a low loud noise. Do you stay or go follow the sounds", choiceOne: "Stay" , choiceTwo: "Explore the sounds" , choiceOneResults: 9, choiceTwoResults: 10},

  {storyOrder: 9, scriptText: "You choose to follow the sounds and find an orca whale. Best day of your life.", choiceOne: " " , choiceTwo: " " , choiceOneResults: null, choiceTwoResults: null},

  {storyOrder: 10, scriptText: "You stay with the jellies. No one has heard from you since", choiceOne: " " , choiceTwo: " " , choiceOneResults: null, choiceTwoResults: null},
